...
f.WriteLine("      <Directory Id=\"ApplicationProgramsFolder\" Name=\"PSDE_$(var.version)\"/>\r\n");
f.WriteLine("    </Directory>\r\n");
f.WriteLine("    <Directory Id=\"$(var.ProgramFilesFolder)\" Name=\"PFiles\">");
f.WriteLine("      <Directory Id=\"PSDE\" Name=\"PSDE\">");
f.WriteLine("        <Directory Id=\"INSTALLDIR\" Name=\"PSDE_$(var.version)\">");
